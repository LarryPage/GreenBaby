...
//    [BackBtn setImage:[UIImage imageNamed:@"back_hl.png"] forState:UIControlStateHighlighted];
...
- (void)updateToolbarItems {
    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
        ...
        //self.navigationController.toolbar.tintColor = [UIColor blackColor];//by lxc modify for iphone
