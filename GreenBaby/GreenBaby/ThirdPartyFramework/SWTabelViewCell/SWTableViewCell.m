...
@property (nonatomic, retain) UIPanGestureRecognizer *tableViewPanGestureRecognizer;
#endif
...
@property (nonatomic, retain) SWUtilityButtonView *leftUtilityButtonsView, *rightUtilityButtonsView;
@property (nonatomic, retain) UIView *leftUtilityClipView, *rightUtilityClipView;
@property (nonatomic, retain) NSLayoutConstraint *leftUtilityClipConstraint, *rightUtilityClipConstraint;
...
- (void)dealloc {
    ...
    [_tableViewPanGestureRecognizer release];
    [_cellScrollView release];
    [_leftUtilityButtonsView release];
    [_rightUtilityButtonsView release];
    [_leftUtilityClipView release];
    [_rightUtilityClipView release];
    [_leftUtilityClipConstraint release];
    [_rightUtilityClipConstraint release];
...
- (void)setContainingTableView:(UITableView *)containingTableView
{
    ...
    self.tableViewPanGestureRecognizer = containingTableView.panGestureRecognizer;
