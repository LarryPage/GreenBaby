...
typedef enum {
    FSEditModeStandard = 0,//正方形,default
    FSEditModeCircular = 1,//圆形
    FSEditModeRectangle = 2//长方形
} FSEditMode;

UIKIT_EXTERN NSString const * UIImagePickerControllerCircularEditedImage;//圆形的
UIKIT_EXTERN NSString const * UIImagePickerControllerRectangleEditedImage;//长方形
#define RectangleRatio  200.0/320.0 //长方形高宽比
...
@property (readonly, nonatomic) UIImage *rectangleEditedImage;
