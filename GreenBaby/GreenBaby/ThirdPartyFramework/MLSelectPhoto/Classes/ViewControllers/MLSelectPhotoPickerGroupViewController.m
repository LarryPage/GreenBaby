...
- (void) setupButtons{
    UIBarButtonItem *barItem = [[UIBarButtonItem alloc] initWithTitle:@"取消" style:UIBarButtonItemStyleDone target:self action:@selector(back)];
...
- (void) jump2StatusVc{
    ...
    assetsVc.doneText = self.doneText;
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    MLSelectPhotoPickerAssetsViewController *assetsVc = [[MLSelectPhotoPickerAssetsViewController alloc] init];
    //assetsVc.selectPickerAssets = self.selectAsstes;
    assetsVc.selectPickerAssets = nil;//modify by lxc
    assetsVc.groupVc = self;
