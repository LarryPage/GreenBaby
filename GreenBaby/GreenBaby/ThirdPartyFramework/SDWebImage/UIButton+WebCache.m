...
- (void)sd_setImageWithURL:(NSURL *)url forState:(UIControlState)state {
    ...
    [self sd_setImageWithURL:url forState:state placeholderImage:nil options:SDWebImageRetryFailed completed:nil];//modify by lxc
}
...
- (void)sd_setImageWithURL:(NSURL *)url forState:(UIControlState)state placeholderImage:(UIImage *)placeholder {
    ...
    [self sd_setImageWithURL:url forState:state placeholderImage:placeholder options:SDWebImageRetryFailed completed:nil];//modify by lxc
}
