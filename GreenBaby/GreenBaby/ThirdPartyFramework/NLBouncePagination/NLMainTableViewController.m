...
- (void)dealloc{
    if (self.pullFreshView) {
        self.pullFreshView.delegate=nil;
        self.pullFreshView.owner=nil;
        self.pullFreshView=nil;
    }
    if (self.subTableViewController) {
        self.subTableViewController.pullFreshView.delegate=nil;
        self.subTableViewController.pullFreshView.owner=nil;
        self.subTableViewController.pullFreshView=nil;
        self.subTableViewController.mainTableViewController = nil;
        self.subTableViewController.tableView.delegate=nil;
        self.subTableViewController.tableView=nil;
