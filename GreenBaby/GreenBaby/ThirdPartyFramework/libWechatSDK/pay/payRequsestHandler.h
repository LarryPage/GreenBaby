...
#define APP_ID          @"wxe603c39076653dd5"
#define APP_SECRET      @"862ef993b2191a7a8d81b8c15de1437f"//支付不用
//商户号，填写商户对应参数
#define MCH_ID          @"1250908001"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"888d18cee51fe17745d6a30dba083bcd"
//支付结果回调页面
