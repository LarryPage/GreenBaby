...
- (void)showPlaceHolder:(BOOL)show
{
    if (show) {
        ...
        placeHolderLabel.wbtHeight = [placeHolderLabel.text adjustSizeWithFont:placeHolderLabel.font constrainedToSize:CGSizeMake(placeHolderLabel.wbtWidth, 1000)].height;
    } else {
        placeHolderLabel.hidden = YES;
    }
}
...
- (void)setMaxNumberOfLines:(NSInteger)n
{
    ...
    if (WBAvalibleOS(7)) {
        ...
        maxHeight = [newText adjustSizeWithFont:self.font
                        constrainedToSize:CGSizeMake(100, CGFLOAT_MAX)].height;
...
- (void)setMinNumberOfLines:(NSInteger)m
{
    ...
    if (WBAvalibleOS(7)) {
        ...
        minHeight = [newText adjustSizeWithFont:self.font
                        constrainedToSize:CGSizeMake(100, CGFLOAT_MAX)].height;
