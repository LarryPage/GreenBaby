...
- (void)sendMessage:(NSString *)message
{
    ...
    NSString * encoded = [[message dataUsingEncoding:NSUTF8StringEncoding] base64EncodedStringWithOptions:NSDataBase64EncodingEndLineWithCarriageReturn]; // base64 encode
