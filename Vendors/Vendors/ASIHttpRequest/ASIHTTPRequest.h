...
//需要额外添加的有: CFNetwork.framework, MobileCoreServices.framework,SystemConfiguration.framework,libz.dylib,libxml2.dylib
//然后"search paths",然后在Header Search paths中添加 ${SDK_DIR}/usr/include/libxml2
