...
static NSTimeInterval defaultTimeOutSeconds = 30;//李香成修改,默认30：[ASIHTTPRequest setDefaultTimeOutSeconds:60];
...
{
    //将请求结果写入文件时行分析 --lxc
//    NSLog(@"%d",rawResponseData.length);
//    NSString* path = [Configs myInfoPlistPath];
//    [rawResponseData writeToFile:path atomically:YES];
