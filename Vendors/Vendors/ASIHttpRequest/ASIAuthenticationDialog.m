...
+ (void)dismiss
{
	if ([sharedDialog respondsToSelector:@selector(presentingViewController)])
        ...
        [[sharedDialog presentingViewController] dismissViewControllerAnimated:YES completion:nil];//6.0
	else
        //modify by lxc
		//[[sharedDialog parentViewController] dismissModalViewControllerAnimated:YES];
        [[sharedDialog parentViewController] dismissViewControllerAnimated:YES completion:nil];//6.0
}
...
- (void)dismiss
{
	if (self == sharedDialog) {
		...
		if ([self respondsToSelector:@selector(presentingViewController)])
            ...
            [[self presentingViewController] dismissViewControllerAnimated:YES completion:nil];//6.0
		else
            //modify by lxc
			//[[self parentViewController] dismissModalViewControllerAnimated:YES];
            [[self parentViewController] dismissViewControllerAnimated:YES completion:nil];//6.0
	}
}
...
- (void)show
{
    ...
    [[self presentingController] dismissViewControllerAnimated:YES completion:nil];//6.0
}
